...
3. The passive subtitle deliberately indicates when Canonical text is longer than the bounded display area. A post-meeting Web detail surface that exposes the complete text has not yet been connected to this candidate.

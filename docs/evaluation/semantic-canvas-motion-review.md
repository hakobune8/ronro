...
To reduce short orphaned wraps without shrinking text, Live Node width is 390 px (previously 360) and Final representative width is 290 px (previously 240), with balanced wrapping. The Final callout collision spacing is increased accordingly. The browser QA checks primary/card overlap and clipping, and the motion fixture checks that the short Option/Decision labels remain one line at 1920×1080. Longer technical labels may still wrap; Canonical text and font sizes are unchanged.
